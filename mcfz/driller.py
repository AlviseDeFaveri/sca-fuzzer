...
class _GdbScriptBuilder:
    ...
    def _declare_skip_hook(self) -> None:
        ...
        Note that we cannot simply use "skip" since it will continue counting hits to the breakpoint.
        """
...
class Driller:
    ...
    def drill_down(self, pc: int) -> None:
        ...
        leak_info.build_gdb_cmd(fast=self._fast, single_step=self._single_step, ignored_funcs=ignored_funcs)
